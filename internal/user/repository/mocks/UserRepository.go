...
func (_m *UserRepository) AssignRole(ctx context.Context, userID string, role string) error {
...
func (_m *UserRepository) BanUser(ctx context.Context, userID string, reason string) error {
...
// CreateOrUpdateUser provides a mock function with given fields: ctx, user
func (_m *UserRepository) CreateOrUpdateUser(ctx context.Context, user goth.User) (*models.User, error) {
	...
	var r0 *models.User
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, goth.User) (*models.User, error)); ok {
		return rf(ctx, user)
	}
	if rf, ok := ret.Get(0).(func(context.Context, goth.User) *models.User); ok {
		r0 = rf(ctx, user)
	} else {
		if ret.Get(0) != nil {
...
func (_m *UserRepository) ListUsers(ctx context.Context, filter models.UserFilter) ([]models.User, error) {
...
func (_m *UserRepository) RevokeRole(ctx context.Context, userID string) error {
	ret := _m.Called(ctx, userID)
...
func (_m *UserRepository) UnbanUser(ctx context.Context, userID string) error {
	ret := _m.Called(ctx, userID)
...
func (_m *UserRepository) UpdateUser(ctx context.Context, userID string, updates models.UserUpdateRequest) error {
